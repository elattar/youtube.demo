...
public class SWDisaster extends ITDisaster
{
	Scanner in = new Scanner(System.in);
	File file  = new File("CatalogSW.txt"); //specify filename and location
	
	/**
	 * This class is an example for SWDisaster catalogue 
	...
	public SWDisaster(String name, String date, String place )
	{
		super(name,date,place);
		System.out.printf("The SW Constructor %s" , this);
		System.out.println("");
	}
	 ...
	 *@param name the name of the SWDisaster to write to the file .
	 */
	...
	public void ReadFromFile()
	{
		...
		try {
		    ...
		    src.useDelimiter(",");
		    System.out.println("\t\t...Reading from 'SW' File ....");
		    while (src.hasNext()) {
